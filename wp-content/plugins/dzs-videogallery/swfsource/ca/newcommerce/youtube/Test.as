...
package ca.newcommerce.youtube
{
	...
	{		
		...
		{
			var ss:SearchSample = new SearchSample();
			...
			YouTubeClient.ORDER_BY_PUBLISHED;
			YouTubeClient.ORDER_BY_RELEVANCE;
			YouTubeClient.ORDER_BY_VIEWCOUNT;
			
			YouTubeClient.TIME_ALL;
			YouTubeClient.TIME_MONTH;
			YouTubeClient.TIME_TODAY;
			YouTubeClient.TIME_WEEK;
			
			YouTubeClient.RACY_EXCLUDE;
			YouTubeClient.RACY_INCLUDE;
